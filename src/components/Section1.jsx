...
const HOUSES = [
  ...
  },
  {
    ...
    colors: ['#c94c00', '#f18805'],
    accent: '#e65c00',
    description:
      'The rulers of the desert peninsula of Dorne. They are fiercely independent and fight with venom and spear, refusing to kneel even to dragons.',
    sigil_url: '/images/martell_sigil.png',
    bg: 'linear-gradient(135deg, #1f0800 0%, #3d1400 60%, #1f0800 100%)',
    borderColor: '#8f3800',
  },
  {
    id: 'arryn',
    ...
    sigil: 'White Falcon and Moon',
    colors: ['#0055a4', '#8cb4e1'],
    accent: '#1976d2',
    description:
      'Lords of the Vale, their impregnable castle reaches into the clouds. From their high mountain peaks, they watch over their lands, untouched by the wars below.',
    sigil_url: '/images/image.png',
    bg: 'linear-gradient(135deg, #00122e 0%, #002855 60%, #00122e 100%)',
    borderColor: '#00438a',
  },
  {
    id: 'tully',
    ...
    accent: '#8b0000',
    description:
      'Lords of the Riverlands, their lands are the crossroads of Westeros. Though oft caught in the crossfire of kings, they endure like the flowing rivers they rule.',
    sigil_url: '/images/image copy 2.png',
    bg: 'linear-gradient(135deg, #021a30 0%, #0a3055 60%, #021a30 100%)',
    borderColor: '#1f4a7a',
  },
]
    ...
    <section ref={sectionRef} className="section1" id="houses">
      ...
      <header className="section1-header">
        ...
        <p className="section1-subtitle fade-up">
          Seven kingdoms. Nine great houses. One Iron Throne.
        </p>
      </header>
